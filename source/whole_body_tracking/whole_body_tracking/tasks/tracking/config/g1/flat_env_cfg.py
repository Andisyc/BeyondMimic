...
G1_23DOF_END_EFFECTOR_BODY_NAMES = [
    "left_ankle_roll_link",
    "right_ankle_roll_link",
    "left_wrist_roll_rubber_hand",
    "right_wrist_roll_rubber_hand",
...
class G1Flat23DoFEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        ...
        self.commands.motion.anchor_body_name = "torso_link"
        self.commands.motion.body_names = G1_23DOF_TRACKING_BODY_NAMES
        self.rewards.undesired_contacts.params["sensor_cfg"].body_names = [
            r"^(?!left_ankle_roll_link$)(?!right_ankle_roll_link$)(?!left_wrist_roll_rubber_hand$)(?!right_wrist_roll_rubber_hand$).+$"
        ]
        self.terminations.ee_body_pos.params["body_names"] = G1_23DOF_END_EFFECTOR_BODY_NAMES
